...
<html>
<head>
	<title>Inicio sesión de Estudiante</title>
				...
				<div class="login col-md-6">
					<form>
						<div class="form-group row">
						    <label for="inputEmail3" class="col-sm-3 col-form-label">Cuenta</label>
						    <div class="col-sm-9">
						      <input type="email" class="form-control" id="inputEmail3" placeholder="Numero de Cuenta">
						    </div>
						  </div>
						  <div class="form-group row">
						  ...
						  <div class="form-group row text-center">
						    <div class="col-sm-12">
						      <a id="btn-login" type="button" href="matricula.php" class="btn btn-primary">Iniciar sesión</a>
						    </div>
						  </div>
					</form>
				</div>
