  ...
  <div class="container-fluid1 ">
    <div class="row app-one">
      ...
      <div  class="col-sm-8 conversation">
        <div id="conversacion">
          <img src="img/Logotipo.jpg"  style="width:100%; height:100%; padding:20px;">
        </div>
        ...
        <!-- Reply Box -->
          <div class="row reply">
            <!--<div id="btn-enviar" class="col-sm-1 col-xs-1 reply-send">
              <img src="img/paper.png" style="width: 24px; height: 28px;">
            </div>--><div class="col-sm-1 col-xs-1 reply-emojis">
